...
Future<void> getdata(String string, String phoneControl) async {
  //var url1 = "http://home.api.rokkhi.com/api/v1/common/getIdToken";
  // var url2 = " http://home.api.rokkhi.com/api/v1/user/getByPhoneNumber";
  /*
    await http.post("http://home.api.rokkhi.com/api/v1/common/getIdToken",
        body: jsonEncode(
...
*/
  ...
  /*print("token from server ${mData.data}");
    print("statusCode from server ${mData.statusCode}");
    print("status from server ${mData.status}");
